...
public class ItemRegistry {
    ...
    public static final RegistryObject<EchoStaffItem> ECHO_STAFF = ITEMS.register("echo_staff",
            () -> new EchoStaffItem(getItemProperties().rarity(Rarity.EPIC).durability(75),
                    100, 20f, 10.0f, 5.0f, 1.0f));
    public static final RegistryObject<WardenEchoStaffItem> WARDEN_ECHO_STAFF = ITEMS.register("warden_echo_staff",
            () -> new WardenEchoStaffItem(getItemProperties().rarity(Rarity.EPIC).durability(100),
                    100, 20f, 15.0f, 5.0f, 1.0f));

    public static final RegistryObject<AmethystEchoStaffItem> AMETHYST_UPGRADED_ECHO_STAFF = ITEMS.register("amethyst_upgraded_echo_staff",
            () -> new AmethystEchoStaffItem(getItemProperties().rarity(Rarity.EPIC).durability(85),
                    80, 20, 10.0f, 7.5f, 1.5f));

    public static final RegistryObject<EnderEchoStaffItem> ENDER_UPGRADED_ECHO_STAFF = ITEMS.register("ender_upgraded_echo_staff",
            () -> new EnderEchoStaffItem(getItemProperties().rarity(Rarity.EPIC).durability(80),
                    100, 20, 10.0f, 5.0f, 1.0f));

    public static final RegistryObject<RoseGoldEchoStaffItem> ROSE_GOLD_UPGRADED_ECHO_STAFF = ITEMS.register("rose_gold_upgraded_echo_staff",
            () -> new RoseGoldEchoStaffItem(getItemProperties().rarity(Rarity.EPIC).durability(90),
                    100, 40, 20.0f, 2.5f, 0.5f));

    public static final RegistryObject<EchoShriekerItem> ECHO_SHRIEKER = ITEMS.register("echo_shrieker",
            () -> new EchoShriekerItem(getFireResistantProperties().rarity(Rarity.EPIC).durability(50)));

    public static final RegistryObject<EchoLocatorItem> ECHO_LOCATOR = ITEMS.register("echo_locator", () ->
    ...
    public static final RegistryObject<ShovelItem> SCULKIFIED_SHOVEL = ITEMS.register("sculkified_shovel", () ->
    ...
    public static final RegistryObject<PickaxeItem> SCULKIFIED_PICKAXE = ITEMS.register("sculkified_pickaxe", () ->
    ...
    public static final RegistryObject<AxeItem> SCULKIFIED_AXE = ITEMS.register("sculkified_axe", () ->
    ...
    public static final RegistryObject<HoeItem> SCULKIFIED_HOE = ITEMS.register("sculkified_hoe", () ->
    ...
    public static final RegistryObject<SwordItem> SCULKIFIED_SWORD = ITEMS.register("sculkified_sword", () ->
    ...
    public static final RegistryObject<WardenArmorItem> SCULKIFIED_HELMET = ITEMS.register("sculkified_helmet", () ->
    ...
    public static final RegistryObject<WardenArmorItem> SCULKIFIED_CHESTPLATE = ITEMS.register("sculkified_chestplate", () ->
    ...
    public static final RegistryObject<WardenArmorItem> SCULKIFIED_LEGGINGS = ITEMS.register("sculkified_leggings", () ->
    ...
    public static final RegistryObject<WardenArmorItem> SCULKIFIED_BOOTS = ITEMS.register("sculkified_boots", () ->
    ...
    public static final RegistryObject<ShovelItem> WARDEN_SHOVEL = ITEMS.register("warden_shovel", () ->
    ...
    public static final RegistryObject<PickaxeItem> WARDEN_PICKAXE = ITEMS.register("warden_pickaxe", () ->
    ...
    public static final RegistryObject<DarknessAxeItem> WARDEN_AXE = ITEMS.register("warden_axe", () ->
    ...
    public static final RegistryObject<HoeItem> WARDEN_HOE = ITEMS.register("warden_hoe", () ->
    ...
    public static final RegistryObject<DarknessSwordItem> WARDEN_SWORD = ITEMS.register("warden_sword", () ->
    ...
    public static final RegistryObject<WardenMaskItem> WARDEN_MASK = ITEMS.register("warden_mask", () ->
    ...
    public static final RegistryObject<Item> SCULK_SHELL = ITEMS.register("sculk_shell", () ->
            new Item(getFireResistantProperties().rarity(Rarity.EPIC).food(WardenFoodItem.getSculkShellProperties())));

    public static final RegistryObject<Item> WARDEN_TENDRIL = ITEMS.register("warden_tendril", () ->
            new Item(getFireResistantProperties().rarity(Rarity.EPIC)));

    public static final RegistryObject<Item> SHRIEKER_FANG = ITEMS.register("shrieker_fang", () ->
            new Item(getFireResistantProperties().rarity(Rarity.RARE)));

    public static final RegistryObject<Item> ECHO_APPLE = ITEMS.register("echo_apple", () ->
    ...
    public static final RegistryObject<SculkArrowItem> SCULK_ARROW = ITEMS.register("sculk_arrow", () ->
            new SculkArrowItem(getFireResistantProperties()));

    public static final RegistryObject<WardenTemplateItem> WARDEN_UPGRADE_SMITHING_TEMPLATE =
            ITEMS.register("warden_upgrade_smithing_template", WardenTemplateItem::createWardenUpgrade);
    public static final RegistryObject<StaffTemplateItem> STAFF_UPGRADE_SMITHING_TEMPLATE =
