...
public class ParticleRegistry {
    ...
    public static final RegistryObject<ParticleType<?>, SimpleParticleType> SHRIEK_PARTICLE = PARTICLE_TYPES.register("shriek_particle", Services.PARTICLE_HELPER::getSimpleParticle);
