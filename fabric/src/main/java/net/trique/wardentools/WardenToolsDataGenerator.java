...
public class WardenToolsDataGenerator implements DataGeneratorEntrypoint {
	...
	public void buildRegistry(RegistrySetBuilder registryBuilder) {
		registryBuilder.add(Registries.CONFIGURED_FEATURE, WardenConfiguredFeatures::bootstrap);
		registryBuilder.add(Registries.PLACED_FEATURE, WardenPlacedFeatures::bootstrap);
	}
}